...
echo ""
echo "---------------------------------------------"
echo "macOS Security Note:"
echo "If you see a warning that the script 'cannot be opened because it is from an unidentified developer':"
echo "  - Right-click the .command file in Finder → Open, OR"
echo "  - Go to System Settings → Privacy & Security → scroll down and click 'Open Anyway'"
echo "  - Or run this in Terminal after download:"
echo "    xattr -d com.apple.quarantine ~/Downloads/start-local-voices.command"
echo "    chmod +x ~/Downloads/start-local-voices.command"
echo "    ~/Downloads/start-local-voices.command"
echo "---------------------------------------------"
