...
function parseReference(reference) {
  ...
  const verseStart = wholeChapter ? 1 : parseInt(match[3], 10);
  const verseEnd = wholeChapter ? Number.POSITIVE_INFINITY : parseInt(match[4] || match[3], 10);
  return {
    bookRaw,
    bookCode,
